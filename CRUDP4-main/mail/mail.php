            ...
            <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                <div class="card card-signin my-5">
                    <div class="card-body">
                        ...
                        <form action="https://formsubmit.co/jorannicolai@gmail.com" method="post" class="form-signin">
                            <div class="form-label-group">
                                <label for="inputEmail">From <span style="color: #FF0000">*</span></label>
                                <input type="text" name="fromEmail" id="fromEmail" class="form-control" value="jorannicolai@gmail.com" readonly required autofocus>
                            </div> <br/>
                            <div class="form-label-group">
