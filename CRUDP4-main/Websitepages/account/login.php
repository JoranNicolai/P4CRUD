...
<head>
    ...
    <link rel="icon" href="./assets/img/xday.png" type="image/x-icon">
    ...
    <div class="page">
        <div class="container">
            <div class="left">
                ...
                <div class="eula">If you don't have an account, please create a new account <a class="register" href="./register.php">Register</a>.</div>
