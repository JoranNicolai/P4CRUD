...
<head>
    ...
    <link rel="stylesheet" href="../../CSS/extra/hotels.css">
</head>
<body>
...
<footer>
    ...
    <div class="blok4">
        <a href="bundels.php"><h3>Vlucht en hotel</h3></a>
    </div>
    <div class="blok5">
        <a href="hotels.php"><h3>Hotels</h3></a>
    </div>
    <div class="blok6">
        <a href="taxi.php"><h3>Taxi's</h3></a>
    </div>
    <div class="blok7">
        <a href="verhuur.php"><h3>Auto verhuur</h3></a>
    </div>
    <div class="blok2">
        <form class="formpje" action="">
            <input class="formpje" type="text" placeholder="Wat is uw locatie?">
        </form>
        <form class="formpje" action="">
            <input class="formpje" type="text" placeholder="waar zou u willen overnachten?">
        </form>
        ...
        <input class="sumbit" type="submit" value="Boek je vlucht">
    </div>
